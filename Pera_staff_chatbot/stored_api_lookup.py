...
def build_lookup_retrieval(
    ...
    # Pass through verification query & table from lookup result
    if lookup_result.get("data_query"):
        single_hit["data_query"] = lookup_result["data_query"]
    if lookup_result.get("data_table"):
        single_hit["data_table"] = lookup_result["data_table"]
